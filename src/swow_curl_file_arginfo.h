...
static const zend_function_entry class_CURLFile_methods[] = {
    ZEND_ME(Swow_CURLFile, __construct, arginfo_class_CURLFile___construct, ZEND_ACC_PUBLIC)
    ZEND_ME(Swow_CURLFile, getFilename, arginfo_class_CURLFile_getFilename, ZEND_ACC_PUBLIC)
    ZEND_ME(Swow_CURLFile, getMimeType, arginfo_class_CURLFile_getMimeType, ZEND_ACC_PUBLIC)
    ZEND_ME(Swow_CURLFile, getPostFilename, arginfo_class_CURLFile_getPostFilename, ZEND_ACC_PUBLIC)
    ZEND_ME(Swow_CURLFile, setMimeType, arginfo_class_CURLFile_setMimeType, ZEND_ACC_PUBLIC)
    ZEND_ME(Swow_CURLFile, setPostFilename, arginfo_class_CURLFile_setPostFilename, ZEND_ACC_PUBLIC)
    ZEND_FE_END
};

static const zend_function_entry class_CURLStringFile_methods[] = {
    ZEND_ME(Swow_CURLStringFile, __construct, arginfo_class_CURLStringFile___construct, ZEND_ACC_PUBLIC)
    ZEND_FE_END
};
...
#else
    class_entry->serialize = zend_class_serialize_deny;
    class_entry->unserialize = zend_class_unserialize_deny;
#endif
